// Since Gulp is basically a Node.js module, we need to require it like a module.
...
gulp.task('sass', function () {
  return gulp
    .src('./styles/*.scss')
    .pipe(sass())
    .pipe(autoprefixer()) // you don't have to manually prefix all the shit for all the browsers
